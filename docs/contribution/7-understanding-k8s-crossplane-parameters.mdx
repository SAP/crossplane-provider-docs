...
**What it controls:** For successfully reconciled resources, how often Crossplane schedules the next reconcile to observe external state and check for drift.
