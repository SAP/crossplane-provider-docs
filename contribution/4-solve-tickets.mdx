...
6. Check that your contribution meets the [**Definition of Done**](/docs/crossplane-provider-docs/contribution/code-release-publish#definition-of-done) and that all tests are **passing**
7. Create a release candidate (see our guide here: [Release process](docs/crossplane-provider-docs/contribution/5-code-release-publish.mdx#build-release-candidate))
