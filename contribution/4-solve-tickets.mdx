...
6. Check that your contribution meets the [**Definition of Done**](/docs/contribution/solve-tickets#definition-of-done) and that all tests are **passing**
7. Create a release candidate (see our guide here: [Release process](/docs/contribution/4-solve-tickets.mdx#create-release-candidate))
